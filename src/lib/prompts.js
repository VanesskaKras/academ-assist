...
@@@SECTION id="1.1"@@@
текст розділу з уніфікованими [N]
@@@SOURCES@@@
Джерело 1 — повний бібліографічний опис
Джерело 2 — повний бібліографічний опис
@@@END@@@

Правила:
- Кожен id з переліку вище повинен утворювати рівно один такий блок
- Якщо розділу немає в тексті — залиш і текст, і список джерел порожніми
- Включай ВЕСЬ текст розділу без скорочень
- Якщо в розділі немає жодного цитування — залиш блок SOURCES порожнім
- Кожне джерело — окремий рядок у блоці SOURCES, без нумерації і маркерів
