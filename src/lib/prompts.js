...
Поверни ТІЛЬКИ JSON (без markdown):
{"planHints":"підказки для СТРУКТУРИ ПЛАНУ: к-сть розділів, назви розділів, висновки до розділів тощо. null якщо немає","textStructureHints":"підказки для СТРУКТУРИ ТЕКСТУ: що має бути у вступі чи висновках, вимоги до обсягів розділів у сторінках, особливі акценти. null якщо немає","writingHints":"підказки для СТИЛЮ ТА ЗМІСТУ написання: термінологія, підходи, що підкреслити, на що звернути увагу. null якщо немає","sourcesHints":"підказки для ДЖЕРЕЛ ТА ОФОРМЛЕННЯ: к-сть джерел, мова джерел, стиль цитування, конкретні автори або видання. null якщо немає","researchDesign":null,"photoTOC":"якщо на фото є готовий план/зміст роботи (рядки виду Chapter 1 / Розділ 1, 1.1, 1.2, Introduction тощо) — скопіюй його текст дослівно. Якщо плану на фото немає — null"}

Правила для поля researchDesign:
Якщо в коментарі є ознаки емпіричного дослідження (анкетування, опитування, тестування, психологічна методика, фізичні тести, педагогічний експеримент, вибірка респондентів, групи учасників) — поверни об'єкт замість null:
{"instrumentType":"questionnaire","groups":[{"name":"назва групи","minN":30,"criteria":"критерії відбору або null"}],"biographicalFields":["ПІБ","вік","стаж","кваліфікація"],"comparisonRequired":true,"statisticalMinN":30}
instrumentType: questionnaire — анкета/опитування; psycho_scale — психологічна методика/шкала/тест; fitness_test — фізичні тести/нормативи/виміри; pedagogical_experiment — педагогічний експеримент з контрольною та експериментальною групами; mixed — кілька різних методів.
groups: масив груп учасників (може бути порожній [] якщо групи не вказані явно). minN — мінімальна кількість осіб у групі або null. criteria — критерії відбору або null.
biographicalFields: поля біографічного блоку анкети якщо згадані (наприклад ПІБ, вік, стаж, кваліфікація, вид спорту тощо). Порожній [] якщо не згадані.
comparisonRequired: true якщо клієнт хоче порівняти групи між собою, false якщо ні.
statisticalMinN: загальна мінімальна вибірка якщо вказана, null якщо не вказана.
Якщо ознак дослідження немає — залиш null.`;
}
