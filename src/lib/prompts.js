...
- КРИТИЧНО ВАЖЛИВО: деякі методички наводять у Додатках НЕ порожній бланк із рисками "___", а вже ЗАПОВНЕНИЙ приклад титулки — з конкретним ПІБ студента, конкретною темою, конкретним факультетом/кафедрою, конкретним керівником (реальні на вигляд, але це чужі дані з прикладу, не дані клієнта). У ЖОДНОМУ разі не копіюй ці конкретні значення дослівно — це призведе до того, що в роботі клієнта з'явиться титулка з іменем і темою зовсім іншої людини. ОБОВ'ЯЗКОВО заміни на узагальнені токени, так само як тему й рік: ПІБ студента → [ПІБ], назву факультету/інституту → [ФАКУЛЬТЕТ], назву кафедри → [КАФЕДРА], ПІБ і посаду наукового керівника → [КЕРІВНИК]. Це стосується як порожніх бланків (де й так стоять риски), так і повністю заповнених прикладів (де стоїть конкретне ім'я на кшталт "Іванов І. І." чи назва кафедри на кшталт "Кафедра фізики") — в обох випадках результат має містити токен, а не чиєсь чуже ім'я чи назву підрозділу
