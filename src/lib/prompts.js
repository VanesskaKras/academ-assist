...
export function buildCorrectionRewritePrompt({ section, originalText, issue, suggestion, info, methodInfo, lang, structureList, existingCitationNumbers, extraGroundingBlock, hasClientIllustrations, allowedNewCitation }) {
  const isEnglish = /англ|english/i.test(lang || "");
  const langLine = isEnglish
    ? "Write ONLY in English."
  ...
  // заборона додавати нові цитування діє завжди, а не лише коли регулярка знайшла [N].
