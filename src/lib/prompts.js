...
- chaptersCount: к-сть основних розділів. null якщо не вказано явно. Якщо методичка взагалі не описує структуру основної частини — повертай 2
- subsectionsPerChapter: к-сть підрозділів на розділ — ТІЛЬКИ якщо у методичці явно вказане конкретне число (наприклад "3 підрозділи", "два підрозділи", "чотири підрозділи"). Розмиті слова "декілька", "кілька", "ряд підрозділів" — НЕ вважаються явною вказівкою, повертай null. null також якщо к-сть взагалі не згадана. Якщо методичка взагалі не описує структуру основної частини — повертай 3
