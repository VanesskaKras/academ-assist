...
- subsectionsPerChapterOverrides: якщо розділи мають РІЗНУ к-сть підрозділів — об'єкт де ключ це номер розділу рядком, значення — к-сть. Тільки ті розділи що відрізняються від subsectionsPerChapter. Приклад: розділ 1 має 2 підрозділи, розділ 2 має 4 — subsectionsPerChapter=2, subsectionsPerChapterOverrides={"2":4}. null якщо всі однакові
