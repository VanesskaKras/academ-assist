...
- diaryTitlePageTemplate: ЦЕ ІНША сторінка, ніж titlePageTemplate вище — не плутай і не копіюй туди те саме. Шукай в Додатках ОКРЕМУ титульну сторінку САМЕ ЩОДЕННИКА практики (заголовок "ЩОДЕННИК ПРАКТИКИ", часто з блоком погодження "ЗАТВЕРДЖУЮ" / "Керівник підприємства (організації, установи)" зверху, і полями студента/інституту/спеціальності знизу). Якщо знайшов — відтвори її стрічка за стрічкою в ТОМУ Ж форматі масиву об'єктів, що й titlePageTemplate (поля "text","align","bold","fontSize","spaceBefore"). Поля для підпису/даних (студент, факультет, спеціальність тощо) залиш як підписи-заголовки полів (напр. "студента ___________________"), НЕ вигадуй конкретні ПІБ чи назви. Якщо такої окремої титулки щоденника в методичці немає — поверни null.
