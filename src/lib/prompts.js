...
export function buildPracticeDiaryPrompt(info, diaryExampleText) {
  const {
    practiceText = "", language = "Українська", practiceGuidance,
...
${diaryExampleText
    ? "Поверни ТІЛЬКИ markdown-таблицю з ТИМИ Ж стовпцями (назви, кількість і порядок), що й у ЗРАЗКУ ЩОДЕННИКА вище. Не додавай, не забирай і не перейменовуй стовпці зразка."
