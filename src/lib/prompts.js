...
## МОВА ТА ДЖЕРЕЛА
${langLine}
${!isEnglish ? "КАТЕГОРИЧНО ЗАБОРОНЕНО вживати англомовні слова, терміни або імена латиницею у тексті. Прізвища та імена іноземних дослідників пиши українською транслітерацією (наприклад, \"Джон Дьюї\", \"Лев Виготський\"). Іноземні терміни (наприклад, experiential learning) замінюй українським відповідником або перекладай. Жодного латинського шрифту в тексті." : ""}
...
- titlePageTemplate: якщо в методичці є зразок титульної сторінки — відтвори її структуру як масив JSON-об'єктів: [{"text":"рядок тексту","align":"center|left|right"}]. Порожній рядок між блоками — {"text":"","align":"center"}. Де має бути тема роботи — постав [ТЕМА]. Де має бути рік — постав [РІК] (НЕ пиши конкретний рік). Вирівнювання визнач за зразком: типово центр, але блоки "Виконав", "Науковий керівник", "Допущено" тощо — right або left залежно від зразка. Якщо зразка немає — поверни null (НЕ вигадуй)
