...
- titlePageTemplate: якщо в методичці є зразок титульної сторінки — відтвори її структуру як масив JSON-об'єктів: [{"text":"рядок тексту","align":"center|left|right"}]. Порожній рядок між блоками — {"text":"","align":"center"}. Де має бути тема роботи (будь-який плейсхолдер: "(найменування теми)", "(назва теми)", "______" тощо) — ОБОВ'ЯЗКОВО заміни на [ТЕМА]. Де має бути рік — ОБОВ'ЯЗКОВО заміни на [РІК] (НЕ пиши конкретний рік і НЕ розбивай рік на кілька рядків). Рядок "Місто – рік" або "Місто, рік" ЗАВЖДИ має бути ОДНИМ рядком: {"text":"Київ – [РІК]","align":"center"}. Вирівнювання визнач за зразком: типово центр, але блоки "Виконав", "Науковий керівник", "Допущено" тощо — right або left залежно від зразка. Якщо зразка немає — поверни null (НЕ вигадуй)
...
Поверни ТІЛЬКИ JSON (без markdown):
{"planHints":"підказки для СТРУКТУРИ ПЛАНУ: к-сть розділів, назви розділів, висновки до розділів тощо. null якщо немає","textStructureHints":"підказки для СТРУКТУРИ ТЕКСТУ: що має бути у вступі чи висновках, вимоги до обсягів розділів у сторінках, особливі акценти. null якщо немає","writingHints":"підказки для СТИЛЮ ТА ЗМІСТУ написання: термінологія, підходи, що підкреслити, на що звернути увагу. null якщо немає","sourcesHints":"підказки для ДЖЕРЕЛ ТА ОФОРМЛЕННЯ: к-сть джерел, мова джерел, стиль цитування, конкретні автори або видання. null якщо немає","empiricalHints":"якщо в коментарі згадується емпіричне дослідження: точна кількість учасників (наприклад '30 осіб'), кількість досліджень або анкет (наприклад '2 дослідження', '2 анкети'), назви методик. null якщо не згадується","photoTOC":"якщо на фото є готовий план/зміст роботи (рядки виду Chapter 1 / Розділ 1, 1.1, 1.2, Introduction тощо) — скопіюй його текст дослівно. Якщо плану на фото немає — null"}`;
}
