...
[{"index":0,"status":"fixed","original":"точний фрагмент з ПОТОЧНОГО тексту роботи, який треба замінити (може включати й репліку рецензента, якщо вона частина виділення) — скопіюй дослівно","replacement":"виправлений варіант без репліки рецензента"}]
...
- "replacement" — виправлений варіант, зберігаючи стиль і мову оригіналу; репліки рецензента в ньому бути не повинно
- Якщо виділення підлягає повному видаленню (наприклад це лише репліка рецензента без окремого дефекту поруч) — "replacement" пустий рядок
