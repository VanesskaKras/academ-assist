...
ВАЖЛИВО:
- Поверни ПОВНИЙ текст роботи з внесеними виправленнями — не скорочуй інші частини
- Виправ ТІЛЬКИ те що зазначено в зауваженні, решту тексту залиш без змін
- Збережи структуру, стиль і мову оригіналу
- Поверни ТІЛЬКИ текст без пояснень`;
}
