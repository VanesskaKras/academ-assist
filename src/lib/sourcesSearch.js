...
Відбери лише статті що РЕАЛЬНО корисні для цього підрозділу. Два рівні:

"exact" — стаття безпосередньо про предмет підрозділу: той самий об'єкт дослідження, та сама галузь, той самий контекст.

"analogy" — ДОЗВОЛЕНО лише якщо:
  • домен збігається (та сама галузь, схожий тип суб'єктів — напр. спортсмени, публічні особи спорту)
  • АБО методологічно дуже близька (наприклад точно такий же тип дослідження в суміжній спортивній дисципліні)
  НЕ є аналогією: статті де спільне лише одне загальне слово (наприклад "імідж", "управління", "розвиток") без зв'язку з конкретним предметом теми. НЕ є аналогією: менеджери, міста, бізнес, освіта, якщо тема про спорт. НЕ є аналогією: загальні огляди без прив'язки до домену теми.

Статті що не відповідають жодному рівню — НЕ включай.
