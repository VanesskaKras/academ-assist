  ...
  return (
    <div className="fade">
      ...
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginTop: 24 }}>
        ...
        <button onClick={() => setStage("corrections")} style={{ background: "transparent", border: "1.5px solid #e8ff47", color: "#e8ff47", borderRadius: 7, padding: "11px 22px", fontFamily: "'Spectral',serif", fontSize: 13, cursor: "pointer" }}>Правки →</button>
      </div>
