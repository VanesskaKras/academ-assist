...
- Онлайн: Прізвище, І. І. (рік). Назва. [посилання з вхідного рядка]
Збережи номери. Поверни ТІЛЬКИ список без заголовка.
КРИТИЧНО: НЕ перекладай і НЕ транслітеруй прізвища та назви.
КРИТИЧНО: Всі посилання https://... або http://... копіюй ТОЧНО як є у вхідному рядку. НЕ замінюй реальні URL на слово "URL" або будь-який інший текст.

${refLines}`
        : `СТИЛЬ: ДСТУ 8302:2015. СУВОРО дотримуйся ДСТУ.
Правила:
- Стаття: Прізвище І. І. Назва статті. *Назва журналу*. рік. № номер. С. xx–xx.
- Онлайн: Прізвище І. І. Назва. [посилання з вхідного рядка] (дата звернення: ${accessDate}).
